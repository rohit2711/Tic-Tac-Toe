...
def b_click(b):
    ...
    if b["text"] == " " and clicked == True:
        ...
        tkinter.messagebox.showerror("Tic-Tac-Toe", "this box is already been selected. please select other box")
...
option_menu.add_command(label="play again", command=reset)
